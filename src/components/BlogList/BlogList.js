...
const BlogList = () => {
  ...
  // Credits to Aleksi44 for the SVG shown below (https://gist.github.com/Aleksi44/48f93dd335a4d8f7fb83702185956fc1?short_path=cc4f5b5)
  const renderCircuitSVG = () => {
    return (
      <svg viewBox="0 0 1500 1500" transform="scale (-1, 1)">
        <defs>
          <linearGradient
